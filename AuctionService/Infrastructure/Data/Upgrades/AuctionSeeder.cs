...
namespace AuctionService.Infrastructure.Data.Upgrades;
...
public static class AuctionSeeder
{
    public static async Task SeedAuctionsAsync(AuctionDbContext context)
    {
        ...
        var dockerPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "SeedData", "auctions.json");
        var devPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "../../../Infrastructure/Data/SeedData/auctions.json");
